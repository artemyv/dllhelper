...
# Source: https://github.com/bemanproject/exemplar (infra/cmake/msvc-toolchain.cmake)
...
# DLLHELPER_BUILDSYS_SANITIZER, however, MSVC does not support thread sanitizer,
...
set(CMAKE_CXX_FLAGS_DEBUG_INIT "/W4 /EHsc /permissive- ${SANITIZER_FLAGS}")
set(CMAKE_C_FLAGS_DEBUG_INIT "/W4 /EHsc /permissive- ${SANITIZER_FLAGS}")

set(RELEASE_FLAGS "/W4 /EHsc /permissive- /O2 ${SANITIZER_FLAGS}")
