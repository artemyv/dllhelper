...
function(vart_install_library name)
    # Usage
    # -----
    #
    #     vart_install_library(NAME)
    #
    # Brief
    # -----
    #
    ...
    if(NOT ARGN STREQUAL "")
        message(
            FATAL_ERROR
            "vart_install_library does not accept extra arguments: ${ARGN}"
        )
    endif()
    ...
    if(NOT name_parts_length EQUAL 2)
        message(
            FATAL_ERROR
            "vart_install_library expects a name of the form '<namespace>.<name>', got '${name}'"
        )
    endif()
    ...
    list(GET name_parts 0 namespace_name)
    ...
    if(install_config_package)
        message(
            DEBUG
            "vart-install-library: Installing a config package for '${name}'"
        )
        ...
        message(
            DEBUG
            "vart-install-library: Not installing a config package for '${name}'"
        )
    endif()
endfunction()
